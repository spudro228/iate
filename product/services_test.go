...
func TestGetAllProducts(t *testing.T) {
	service := NewInMemoryProductService()
	product1 := Product{CreatedAt: CustomDate{time.Now()}, Guid: "g12312-0", ProductName: "Test1", Weight: 100, Calories: 200, Proteins: 1.1, Fats: 2.2, Carbohydrates: 3.3}
	product2 := Product{CreatedAt: CustomDate{time.Now()}, Guid: "g12312-1", ProductName: "Test2", Weight: 200, Calories: 300, Proteins: 2.2, Fats: 3.3, Carbohydrates: 4.4}
...
func TestGetAllProductsToday(t *testing.T) {
	...
	product1 := Product{CreatedAt: CustomDate{time.Now()}, Guid: "g12312-0", ProductName: "Test1", Weight: 100, Calories: 200, Proteins: 1.1, Fats: 2.2, Carbohydrates: 3.3}
	product2 := Product{CreatedAt: CustomDate{createdAt}, Guid: "g12312-1", ProductName: "Test2", Weight: 200, Calories: 300, Proteins: 2.2, Fats: 3.3, Carbohydrates: 4.4}
	service.SaveProduct(product1, "u001")
	service.SaveProduct(product2, "u001")
